...
static unsigned char x_magic[32] = {0x9b,0xaa,0x31,0xe1,0x96,0x41,0x43,0xa7,
                                    0x05,0x4a,0x0e,0x90,0xc4,0x40,0x3d,0x36,
                                    0x6c,0x87,0x37,0x41,0x28,0x2b,0xa2,0x7b,
...
static unsigned char* file_ext_decrypt(unsigned char* buf_in, int buf_in_size, int* buf_out_size)
{
    ...
    if(memcmp(buf_in, x_magic, sizeof(x_magic)) != 0)
    {
        return NULL;
    }
    buf_in += sizeof(x_magic);
    buf_in_size -= sizeof(x_magic);
